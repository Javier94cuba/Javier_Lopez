...
import send from "/src/assets/images/arrow_down.png"
  ...
  return (
    <div className=" w-full h-full bg-white dark:bg-slate-900 text-slate-200 mt-10 dark:mt-0 dark:pb-10">
      <div className="md:flex md:justify-center md:space-x-10">
        ...
        <div>
        <p><a target="_blank" href={cv}>
        <Button  text={"Download CV"} img_alt={send}/>
        </a>
        </p>
        </div>
        </div>
      ...
      <div className="columns-3 md:flex md:space-x-20 pt-4 md:justify-center md:items-center">
      <Tecnologies image_url={react_img} text_image={"ReactJs"}/>
      <Tecnologies image_url={typescript} text_image={"Typescript"}/>
      <Tecnologies image_url={tailwind} text_image={"Tailwind"}/>
      <Tecnologies image_url={wordpress} text_image={"Wordpress"}/>
      <Tecnologies image_url={react_native} text_image={"NextJs"}/>
